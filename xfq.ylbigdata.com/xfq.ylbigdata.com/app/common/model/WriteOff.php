...
class WriteOff extends Base
{
    ...
    {
        return $this->belongsTo('CouponIssueUser', 'coupon_issue_user_id');
    }
    ...
    {
        return $this->belongsTo('UsersModel', 'uid')->field('id,sex,email,last_login_time,last_login_ip,mobile,type_id,status,idcard,create_time,update_time,name,headimgurl,nickname,salt,uuid,openid');
    }
