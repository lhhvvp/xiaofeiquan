...
/**
 * 后台中间件
 * @author slomoo <slomoo@aliyun.com> 2022-02-15
 */
namespace app\seller\middleware;
...
class Admin
{
    ...
    {   
        ...
        $class_id  = Session::get('seller.class_id');
        ...
        if ($seller['email_validated'] !=1 || $seller['status'] !=1){
            return redirect((string)url('register/index'));
        }
