...
class Index extends Base
{
    ...
    public function screen(){
        ...
        // 查询某一个月内的每天的核销数量
        $writeoff = \app\common\model\WriteOff::where('mid',session()['seller']['id'])->whereBetweenTime('create_time',$start_time, $now_time)
            ->field("FROM_UNIXTIME(create_time,'yyyy-mm-dd') as date,count(1) as total")
            ->group("FROM_UNIXTIME(create_time,'yyyy-mm-dd')")
            ->select();
        // 数据填充
