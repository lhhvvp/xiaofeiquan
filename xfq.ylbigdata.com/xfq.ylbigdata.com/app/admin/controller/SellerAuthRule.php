...
/**
 * 普通商户菜单规则控制器
 * @author slomoo <slomoo@aliyun.com> 2023-06-27
 */
...
class SellerAuthRule extends Base
{
    // 验证器
    protected $validate = 'SellerAuthRule';

    // 当前主表
    protected $tableName = 'seller_auth_rule';

    // 当前主模型
    protected $modelName = 'SellerAuthRule';
