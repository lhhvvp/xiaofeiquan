...
abstract class Base
{
     ...
     * @var array
     */
    protected $middleware = ['app\travel\middleware\Admin'];
    ...
    protected function initialize()
    {
        ...
        // 数据库驱动文件
        $this->dbType = env('database.type');

        // 左侧菜单
        $menus = \app\travel\model\Base::getMenus();
        View::assign(['menus' => json_decode($menus,true)]);
