    ...
    $.extend({
        ...
        table: {
            ...
            allTableData: function () {
                return $.btTable.bootstrapTable('getData');
            }
        ...
        modal: {
            ...
            openOptions: function (options) {
                ...
                if ($.common.isEmpty(options.yes)) {
                    //修改了一个判断
                    if (options.that != undefined) {
                        options.yes = function (index, layero) {
                            options.callBack(index, layero, options.that);
                        }
                    } else {
                        options.yes = function (index, layero) {
        ...
        operate: {
            ...
            bindUrl: function (id) {
                var url = "";
                if ($.common.isNotEmpty(id)) {
                    url = $.table._option.bindUrl.replace("__id__", id);
                }
                // 获取搜索信息
                var back = $.common.serializeRemoveNull($("#search_form").serialize());
                back = back ? '&back_url=' + encodeURIComponent(back) : '';
