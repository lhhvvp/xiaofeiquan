<template>
	<view class="box">
		<view class="logo-box">
			<view class="logo">
				<image src="https://oss.wlxfq.dianfengcms.com/wechat/bg.png"></image>
			</view>
										...
										.then(ret => {
											if (ret.code == 0) {
												let data = {
													...
													name: ret.data.userinfo.name ? true :
														false, //姓名
													idcard: ret.data.userinfo.idcard ? true :
														false, //身份证号
													mobile: ret.data.userinfo.mobile ? true :
														false, //手机号
