	...
	<view class="coupon-cav">
		...
		<view class="box">
			...
			<view class="coupon-box">
				<view class="title">{{ info.seller.nickname || '' }} <text v-if="receiveInfo.title">- {{receiveInfo.title}}</text>
				</view>
				<view class="price" v-if="receiveInfo.price != 0">{{ receiveInfo.price || 0 }} </view>
				<view class="type">
					核销人数
					<text style="color: #a00000;font-weight: bold;display: inline-block;padding: 0 6upx;">1</text>
					人
				</view>
			</view>
			...
			<view class="content-info">
				<view class="time-box">
					...
					<view class="info">{{ info.ticket_title }}</view>
				</view>

				<view class="time-box">
					<view class="title">联系人：</view>
					<view class="info">{{ info.tourist_fullname }}</view>
				</view>
				<view class="time-box">
					<view class="title">联系方式：</view>
					<view class="info">{{ info.tourist_mobile }}</view>
				</view>

				<view class="info-box">
					<view class="title">购买说明：</view>
					<view class="info"><rich-text :nodes="info.explain_buy"></rich-text></view>
				</view>
				<view class="info-box">
					<view class="title">使用说明：</view>
					<view class="info"><rich-text :nodes="info.explain_use"></rich-text></view>
				</view>
			</view>
		</view>
	</view>
